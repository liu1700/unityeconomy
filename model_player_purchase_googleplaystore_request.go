...
// checks if the PlayerPurchaseGoogleplaystoreRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlayerPurchaseGoogleplaystoreRequest{}

// PlayerPurchaseGoogleplaystoreRequest struct for PlayerPurchaseGoogleplaystoreRequest
type PlayerPurchaseGoogleplaystoreRequest struct {
	// ID of the purchase.
	Id string `json:"id"`
	...
	PurchaseDataSignature string `json:"purchaseDataSignature"`
...
func NewPlayerPurchaseGoogleplaystoreRequest(id string, purchaseData string, purchaseDataSignature string, localCost int32, localCurrency string) *PlayerPurchaseGoogleplaystoreRequest {
	this := PlayerPurchaseGoogleplaystoreRequest{}
	this.Id = id
...
// GetPurchaseData returns the PurchaseData field value
func (o *PlayerPurchaseGoogleplaystoreRequest) GetPurchaseData() string {
	...
	return o.PurchaseData
}

// GetPurchaseDataOk returns a tuple with the PurchaseData field value
// and a boolean to check if the value has been set.
func (o *PlayerPurchaseGoogleplaystoreRequest) GetPurchaseDataOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PurchaseData, true
}

// SetPurchaseData sets field value
func (o *PlayerPurchaseGoogleplaystoreRequest) SetPurchaseData(v string) {
	o.PurchaseData = v
}

// GetPurchaseDataSignature returns the PurchaseDataSignature field value
func (o *PlayerPurchaseGoogleplaystoreRequest) GetPurchaseDataSignature() string {
	...
	return o.PurchaseDataSignature
}

// GetPurchaseDataSignatureOk returns a tuple with the PurchaseDataSignature field value
// and a boolean to check if the value has been set.
func (o *PlayerPurchaseGoogleplaystoreRequest) GetPurchaseDataSignatureOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.PurchaseDataSignature, true
}

// SetPurchaseDataSignature sets field value
func (o *PlayerPurchaseGoogleplaystoreRequest) SetPurchaseDataSignature(v string) {
	o.PurchaseDataSignature = v
}
...
func (o PlayerPurchaseGoogleplaystoreRequest) MarshalJSON() ([]byte, error) {
...
func (o PlayerPurchaseGoogleplaystoreRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["id"] = o.Id
	toSerialize["purchaseData"] = o.PurchaseData
	toSerialize["purchaseDataSignature"] = o.PurchaseDataSignature
	toSerialize["localCost"] = o.LocalCost
	toSerialize["localCurrency"] = o.LocalCurrency
	return toSerialize, nil
}

type NullablePlayerPurchaseGoogleplaystoreRequest struct {
	value *PlayerPurchaseGoogleplaystoreRequest
	isSet bool
}

func (v NullablePlayerPurchaseGoogleplaystoreRequest) Get() *PlayerPurchaseGoogleplaystoreRequest {
	return v.value
}

func (v *NullablePlayerPurchaseGoogleplaystoreRequest) Set(val *PlayerPurchaseGoogleplaystoreRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePlayerPurchaseGoogleplaystoreRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePlayerPurchaseGoogleplaystoreRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlayerPurchaseGoogleplaystoreRequest(val *PlayerPurchaseGoogleplaystoreRequest) *NullablePlayerPurchaseGoogleplaystoreRequest {
	return &NullablePlayerPurchaseGoogleplaystoreRequest{value: val, isSet: true}
}

func (v NullablePlayerPurchaseGoogleplaystoreRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlayerPurchaseGoogleplaystoreRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
