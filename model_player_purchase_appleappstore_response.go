...
// checks if the PlayerPurchaseAppleappstoreResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlayerPurchaseAppleappstoreResponse{}

// PlayerPurchaseAppleappstoreResponse struct for PlayerPurchaseAppleappstoreResponse
type PlayerPurchaseAppleappstoreResponse struct {
	Verification PlayerPurchaseAppleappstoreResponseVerification `json:"verification"`
...
func NewPlayerPurchaseAppleappstoreResponse(verification PlayerPurchaseAppleappstoreResponseVerification, rewards PlayerPurchaseVirtualResponseRewards) *PlayerPurchaseAppleappstoreResponse {
	this := PlayerPurchaseAppleappstoreResponse{}
...
func (o *PlayerPurchaseAppleappstoreResponse) GetVerification() PlayerPurchaseAppleappstoreResponseVerification {
	if o == nil {
		var ret PlayerPurchaseAppleappstoreResponseVerification
		return ret
	}
...
func (o PlayerPurchaseAppleappstoreResponse) MarshalJSON() ([]byte, error) {
...
func (o PlayerPurchaseAppleappstoreResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePlayerPurchaseAppleappstoreResponse struct {
	value *PlayerPurchaseAppleappstoreResponse
	isSet bool
}

func (v NullablePlayerPurchaseAppleappstoreResponse) Get() *PlayerPurchaseAppleappstoreResponse {
	return v.value
}

func (v *NullablePlayerPurchaseAppleappstoreResponse) Set(val *PlayerPurchaseAppleappstoreResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePlayerPurchaseAppleappstoreResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePlayerPurchaseAppleappstoreResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlayerPurchaseAppleappstoreResponse(val *PlayerPurchaseAppleappstoreResponse) *NullablePlayerPurchaseAppleappstoreResponse {
	return &NullablePlayerPurchaseAppleappstoreResponse{value: val, isSet: true}
}

func (v NullablePlayerPurchaseAppleappstoreResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlayerPurchaseAppleappstoreResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
