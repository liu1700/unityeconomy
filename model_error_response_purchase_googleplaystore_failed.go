...
// checks if the ErrorResponsePurchaseGoogleplaystoreFailed type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ErrorResponsePurchaseGoogleplaystoreFailed{}

// ErrorResponsePurchaseGoogleplaystoreFailed An error response sent back upon a redeem Google Play purchase.
type ErrorResponsePurchaseGoogleplaystoreFailed struct {
	...
	Data PlayerPurchaseGoogleplaystoreResponse `json:"data"`
}
...
func NewErrorResponsePurchaseGoogleplaystoreFailed(type_ string, title string, status int32, code int32, detail string, data PlayerPurchaseGoogleplaystoreResponse) *ErrorResponsePurchaseGoogleplaystoreFailed {
	this := ErrorResponsePurchaseGoogleplaystoreFailed{}
	this.Type = type_
	this.Title = title
	this.Status = status
	this.Code = code
...
func (o *ErrorResponsePurchaseGoogleplaystoreFailed) GetData() PlayerPurchaseGoogleplaystoreResponse {
	if o == nil {
		var ret PlayerPurchaseGoogleplaystoreResponse
		return ret
	}
...
func (o ErrorResponsePurchaseGoogleplaystoreFailed) MarshalJSON() ([]byte, error) {
...
func (o ErrorResponsePurchaseGoogleplaystoreFailed) ToMap() (map[string]interface{}, error) {
...
type NullableErrorResponsePurchaseGoogleplaystoreFailed struct {
	value *ErrorResponsePurchaseGoogleplaystoreFailed
	isSet bool
}

func (v NullableErrorResponsePurchaseGoogleplaystoreFailed) Get() *ErrorResponsePurchaseGoogleplaystoreFailed {
	return v.value
}

func (v *NullableErrorResponsePurchaseGoogleplaystoreFailed) Set(val *ErrorResponsePurchaseGoogleplaystoreFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorResponsePurchaseGoogleplaystoreFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorResponsePurchaseGoogleplaystoreFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorResponsePurchaseGoogleplaystoreFailed(val *ErrorResponsePurchaseGoogleplaystoreFailed) *NullableErrorResponsePurchaseGoogleplaystoreFailed {
	return &NullableErrorResponsePurchaseGoogleplaystoreFailed{value: val, isSet: true}
}

func (v NullableErrorResponsePurchaseGoogleplaystoreFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorResponsePurchaseGoogleplaystoreFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
