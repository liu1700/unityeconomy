...
// SetPlayerCurrencyBalance400Response - struct for SetPlayerCurrencyBalance400Response
type SetPlayerCurrencyBalance400Response struct {
	BasicErrorResponse *BasicErrorResponse
	ValidationErrorResponse *ValidationErrorResponse
}

// BasicErrorResponseAsSetPlayerCurrencyBalance400Response is a convenience function that returns BasicErrorResponse wrapped in SetPlayerCurrencyBalance400Response
func BasicErrorResponseAsSetPlayerCurrencyBalance400Response(v *BasicErrorResponse) SetPlayerCurrencyBalance400Response {
	return SetPlayerCurrencyBalance400Response{
		BasicErrorResponse: v,
	}
}

// ValidationErrorResponseAsSetPlayerCurrencyBalance400Response is a convenience function that returns ValidationErrorResponse wrapped in SetPlayerCurrencyBalance400Response
func ValidationErrorResponseAsSetPlayerCurrencyBalance400Response(v *ValidationErrorResponse) SetPlayerCurrencyBalance400Response {
	return SetPlayerCurrencyBalance400Response{
...
func (dst *SetPlayerCurrencyBalance400Response) UnmarshalJSON(data []byte) error {
	var err error
	match := 0
	...
	if match > 1 { // more than 1 match
		...
		return fmt.Errorf("data matches more than one schema in oneOf(SetPlayerCurrencyBalance400Response)")
	} else if match == 1 {
		return nil // exactly one match
	} else { // no match
		return fmt.Errorf("data failed to match schemas in oneOf(SetPlayerCurrencyBalance400Response)")
	}
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src SetPlayerCurrencyBalance400Response) MarshalJSON() ([]byte, error) {
...
func (obj *SetPlayerCurrencyBalance400Response) GetActualInstance() (interface{}) {
	if obj == nil {
		return nil
	}
...
type NullableSetPlayerCurrencyBalance400Response struct {
	value *SetPlayerCurrencyBalance400Response
	isSet bool
}

func (v NullableSetPlayerCurrencyBalance400Response) Get() *SetPlayerCurrencyBalance400Response {
	return v.value
}

func (v *NullableSetPlayerCurrencyBalance400Response) Set(val *SetPlayerCurrencyBalance400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSetPlayerCurrencyBalance400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSetPlayerCurrencyBalance400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSetPlayerCurrencyBalance400Response(val *SetPlayerCurrencyBalance400Response) *NullableSetPlayerCurrencyBalance400Response {
	return &NullableSetPlayerCurrencyBalance400Response{value: val, isSet: true}
}

func (v NullableSetPlayerCurrencyBalance400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSetPlayerCurrencyBalance400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
