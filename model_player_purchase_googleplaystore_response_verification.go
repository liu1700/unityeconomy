...
// checks if the PlayerPurchaseGoogleplaystoreResponseVerification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlayerPurchaseGoogleplaystoreResponseVerification{}

// PlayerPurchaseGoogleplaystoreResponseVerification struct for PlayerPurchaseGoogleplaystoreResponseVerification
type PlayerPurchaseGoogleplaystoreResponseVerification struct {
	...
	Store PlayerPurchaseGoogleplaystoreResponseVerificationStore `json:"store"`
}
...
func NewPlayerPurchaseGoogleplaystoreResponseVerification(status string, store PlayerPurchaseGoogleplaystoreResponseVerificationStore) *PlayerPurchaseGoogleplaystoreResponseVerification {
	this := PlayerPurchaseGoogleplaystoreResponseVerification{}
	this.Status = status
	this.Store = store
	return &this
}
...
func (o *PlayerPurchaseGoogleplaystoreResponseVerification) GetStore() PlayerPurchaseGoogleplaystoreResponseVerificationStore {
	if o == nil {
		var ret PlayerPurchaseGoogleplaystoreResponseVerificationStore
		return ret
	}
...
func (o PlayerPurchaseGoogleplaystoreResponseVerification) MarshalJSON() ([]byte, error) {
...
func (o PlayerPurchaseGoogleplaystoreResponseVerification) ToMap() (map[string]interface{}, error) {
...
type NullablePlayerPurchaseGoogleplaystoreResponseVerification struct {
	value *PlayerPurchaseGoogleplaystoreResponseVerification
	isSet bool
}

func (v NullablePlayerPurchaseGoogleplaystoreResponseVerification) Get() *PlayerPurchaseGoogleplaystoreResponseVerification {
	return v.value
}

func (v *NullablePlayerPurchaseGoogleplaystoreResponseVerification) Set(val *PlayerPurchaseGoogleplaystoreResponseVerification) {
	v.value = val
	v.isSet = true
}

func (v NullablePlayerPurchaseGoogleplaystoreResponseVerification) IsSet() bool {
	return v.isSet
}

func (v *NullablePlayerPurchaseGoogleplaystoreResponseVerification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlayerPurchaseGoogleplaystoreResponseVerification(val *PlayerPurchaseGoogleplaystoreResponseVerification) *NullablePlayerPurchaseGoogleplaystoreResponseVerification {
	return &NullablePlayerPurchaseGoogleplaystoreResponseVerification{value: val, isSet: true}
}

func (v NullablePlayerPurchaseGoogleplaystoreResponseVerification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlayerPurchaseGoogleplaystoreResponseVerification) UnmarshalJSON(src []byte) error {
	v.isSet = true
