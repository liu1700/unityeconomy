...
// checks if the CurrencyExchangeItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurrencyExchangeItem{}

// CurrencyExchangeItem struct for CurrencyExchangeItem
type CurrencyExchangeItem struct {
	// ID of the currency.
	Id string `json:"id"`
...
func (o CurrencyExchangeItem) MarshalJSON() ([]byte, error) {
...
func (o CurrencyExchangeItem) ToMap() (map[string]interface{}, error) {
...
type NullableCurrencyExchangeItem struct {
	value *CurrencyExchangeItem
	isSet bool
}

func (v NullableCurrencyExchangeItem) Get() *CurrencyExchangeItem {
	return v.value
}

func (v *NullableCurrencyExchangeItem) Set(val *CurrencyExchangeItem) {
	v.value = val
	v.isSet = true
}

func (v NullableCurrencyExchangeItem) IsSet() bool {
	return v.isSet
}

func (v *NullableCurrencyExchangeItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCurrencyExchangeItem(val *CurrencyExchangeItem) *NullableCurrencyExchangeItem {
	return &NullableCurrencyExchangeItem{value: val, isSet: true}
}

func (v NullableCurrencyExchangeItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCurrencyExchangeItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
