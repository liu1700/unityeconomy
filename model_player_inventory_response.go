...
// checks if the PlayerInventoryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlayerInventoryResponse{}

// PlayerInventoryResponse struct for PlayerInventoryResponse
type PlayerInventoryResponse struct {
	// List of player's inventory items.
	Results []InventoryResponse `json:"results"`
...
func (o PlayerInventoryResponse) MarshalJSON() ([]byte, error) {
...
func (o PlayerInventoryResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePlayerInventoryResponse struct {
	value *PlayerInventoryResponse
	isSet bool
}

func (v NullablePlayerInventoryResponse) Get() *PlayerInventoryResponse {
	return v.value
}

func (v *NullablePlayerInventoryResponse) Set(val *PlayerInventoryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePlayerInventoryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePlayerInventoryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlayerInventoryResponse(val *PlayerInventoryResponse) *NullablePlayerInventoryResponse {
	return &NullablePlayerInventoryResponse{value: val, isSet: true}
}

func (v NullablePlayerInventoryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlayerInventoryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
