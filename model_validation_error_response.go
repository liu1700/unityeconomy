...
// ValidationErrorResponse Validation error response when a value provided from the client does not pass validation on server. 
type ValidationErrorResponse struct {
	...
	Errors []ValidationErrorBody `json:"errors"`
}
