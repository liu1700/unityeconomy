...
// checks if the PlayerPurchaseVirtualResponseRewards type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlayerPurchaseVirtualResponseRewards{}

// PlayerPurchaseVirtualResponseRewards Rewards of the purchase.
type PlayerPurchaseVirtualResponseRewards struct {
...
func NewPlayerPurchaseVirtualResponseRewards(inventory []InventoryExchangeItem) *PlayerPurchaseVirtualResponseRewards {
	this := PlayerPurchaseVirtualResponseRewards{}
...
func (o PlayerPurchaseVirtualResponseRewards) MarshalJSON() ([]byte, error) {
...
func (o PlayerPurchaseVirtualResponseRewards) ToMap() (map[string]interface{}, error) {
...
type NullablePlayerPurchaseVirtualResponseRewards struct {
	value *PlayerPurchaseVirtualResponseRewards
	isSet bool
}

func (v NullablePlayerPurchaseVirtualResponseRewards) Get() *PlayerPurchaseVirtualResponseRewards {
	return v.value
}

func (v *NullablePlayerPurchaseVirtualResponseRewards) Set(val *PlayerPurchaseVirtualResponseRewards) {
	v.value = val
	v.isSet = true
}

func (v NullablePlayerPurchaseVirtualResponseRewards) IsSet() bool {
	return v.isSet
}

func (v *NullablePlayerPurchaseVirtualResponseRewards) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlayerPurchaseVirtualResponseRewards(val *PlayerPurchaseVirtualResponseRewards) *NullablePlayerPurchaseVirtualResponseRewards {
	return &NullablePlayerPurchaseVirtualResponseRewards{value: val, isSet: true}
}

func (v NullablePlayerPurchaseVirtualResponseRewards) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlayerPurchaseVirtualResponseRewards) UnmarshalJSON(src []byte) error {
	v.isSet = true
