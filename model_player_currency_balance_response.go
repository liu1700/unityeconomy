...
// checks if the PlayerCurrencyBalanceResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlayerCurrencyBalanceResponse{}

// PlayerCurrencyBalanceResponse struct for PlayerCurrencyBalanceResponse
type PlayerCurrencyBalanceResponse struct {
	// List of currency balances.
	Results []CurrencyBalanceResponse `json:"results"`
	Links PlayerCurrencyBalanceResponseLinks `json:"links"`
}
...
func NewPlayerCurrencyBalanceResponse(results []CurrencyBalanceResponse, links PlayerCurrencyBalanceResponseLinks) *PlayerCurrencyBalanceResponse {
	this := PlayerCurrencyBalanceResponse{}
...
func (o *PlayerCurrencyBalanceResponse) GetLinks() PlayerCurrencyBalanceResponseLinks {
	if o == nil {
		var ret PlayerCurrencyBalanceResponseLinks
		return ret
	}
...
func (o PlayerCurrencyBalanceResponse) MarshalJSON() ([]byte, error) {
...
func (o PlayerCurrencyBalanceResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePlayerCurrencyBalanceResponse struct {
	value *PlayerCurrencyBalanceResponse
	isSet bool
}

func (v NullablePlayerCurrencyBalanceResponse) Get() *PlayerCurrencyBalanceResponse {
	return v.value
}

func (v *NullablePlayerCurrencyBalanceResponse) Set(val *PlayerCurrencyBalanceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePlayerCurrencyBalanceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePlayerCurrencyBalanceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlayerCurrencyBalanceResponse(val *PlayerCurrencyBalanceResponse) *NullablePlayerCurrencyBalanceResponse {
	return &NullablePlayerCurrencyBalanceResponse{value: val, isSet: true}
}

func (v NullablePlayerCurrencyBalanceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlayerCurrencyBalanceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
